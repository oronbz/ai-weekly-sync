...
- [Openclaw](https://openclaw.ai/) by ([Peter Steinberger](https://github.com/steipete))
...
- Copilot CLI
  - [Plan Mode](https://github.blog/changelog/2026-01-21-github-copilot-cli-plan-before-you-build-steer-as-you-go/#plan-mode)
...
- [AGENTS/CLAUDE.md](https://github.com/gtforge/gtforge-iphone/blob/master/AGENTS.md)

## 📝 Action Items

- Setup your battle-station (Ghostty, GitHub CLI)
- Add an MCP
- Add AGENTS.md to one of your projects
- Test the limits!
